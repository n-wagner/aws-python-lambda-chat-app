...
def get_recent_messages(event, context):
  ...
  logger.debug("current_user_left: {} current_user_exclusion_list: {} ", current_user_left, current_user_exclusion_list)


  logger.debug("group: {} count: {} count_type: {}", group, count, type(count))
  count = int(count)
  ...
  logger.debug("item_len: {} new_messages_count: {}", item_len, new_messages_count)
  messages = []
